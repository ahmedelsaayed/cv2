...
const getUserInputs = () => {
    ...
    skillElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Language')));
...
const displayCV = (userData) => {
    ...
    showListData(userData.Lang, Language);
